...
module.exports = {
    ...
    CAPTION_KEY: process.env.CAPTION_KEY === undefined ?'Made By Zara' : process.env.CAPTION_KEY,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'ALL MEMBERS👇' : process.env.TAG_HEADER,
