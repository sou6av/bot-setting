{
    "name": "Raganork BOT",
    "description": "Raganork bot - Edited from Whatsasena public.  Makes it easy and fun to use Whatsapp. World’s first UserBot made for WhatsApp.",
    "logo": "https://github.com/souravkl11/raganork/raw/master/raga.jpg",
    ...
    "env": {
        ...
        "ALIVE_MESSAGE": {
            ...
            "required": false,
            "value": "\n ```Killadism never ends !!!```\n\n```Type``` *.help* ```for commands```\n\n```𝐑𝐀𝐆𝐀𝐍𝐎𝐑𝐊```\n\n *Coded by Souravkl11*\n\n```Contact owner: wa.me/91xxxxxxxxxx"
        },
        "BAN_MESSAGE": {
