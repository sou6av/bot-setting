...
r_text[1] = "Zara kuttiye tholpikkaan ningalkavilla. Jeevitathil Zara kuttiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Zara kutti says i love you 😘";
r_text[3] = "Zara kuttiudeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Zara kutti - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Zara kutti ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than ORU SATHA MANUSHYAN";
...
r_text[13] = ".song adich thangalude fav song name para Zara kutti ath download aakki theraam";
...
r_text[18] = "enikk njan und Zara kutti uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Zara kutti pazhaya Zara kutti thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Zara kuttiik";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Zara kutti";
