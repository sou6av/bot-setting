...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'zavatar1 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    var ttinullimage = await axios.get(`https://api.lolhuman.xyz/api/ephoto1/avatardota?apikey=queenamdipublic&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
