...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'zsky ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    var ttinullimage = await axios.get(`https://api.zeks.xyz/api/skytext?apikey=4PXD3f97yHgcO8aOD5GGIsEJB6l&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
