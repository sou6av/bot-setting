            ...
            Asena.commands.map(
                async (command) =>  {
                    ...
                    try {
                        ...
                        var ttinullimage = await axios.get Config.LOGOSK
